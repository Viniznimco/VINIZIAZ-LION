    ...
    if (_0x1f45f8) {
      switch (_0x312252) {
                ...
                _0x5e9ccc.sendMessage(_0x4be48e.chat, {
                  ...
                  'contextInfo': {
                    'externalAdReply': {
                      ...
                      'sourceUrl': 'https://wa.me/254759925133?text=Hello👋+Nimco+Niplug+Bot+gee+😔',
                      'mediaType': 0x1,
        ...
        case "devil":
          {
            var _0x10e953 = require("mumaker");
            if (!_0x1d9323 || _0x1d9323 == '') {
              _0x4be48e.reply("Example Usage : " + prefix + "Mighty Nimco");
              return;
            }
            try {
        ...
        case 'purple':
          {
            var _0x10e953 = require("mumaker");
            if (!_0x1d9323 || _0x1d9323 == '') {
              _0x4be48e.reply("Example Usage : " + prefix + "purple Nimco");
              return;
            }
            try {
        ...
        case "thunder":
          {
            var _0x10e953 = require("mumaker");
            if (!_0x1d9323 || _0x1d9323 == '') {
              _0x4be48e.reply("Example Usage : " + prefix + "Thunder Nimco");
              return;
            }
            try {
        ...
        case "leaves":
          {
            var _0x10e953 = require("mumaker");
            if (!_0x1d9323 || _0x1d9323 == '') {
              _0x4be48e.reply("Example Usage : " + prefix + "Leaves VINIZIAZ-MD");
              return;
            }
            try {
        ...
        case 'arena':
          {
            var _0x10e953 = require('mumaker');
            if (!_0x1d9323 || _0x1d9323 == '') {
              _0x4be48e.reply("Example Usage : " + prefix + "arena VINIZIAZ-MD");
              return;
            }
            try {
        ...
        case "raven":
          {
            if (!_0x1d9323) {
              return _0x4edf32("Hello I'm VINIZIAZ AI. How can i help u?");
            }
        ...
        case 'ai':
          {
            ...
            try {
              ...
              if (!_0x1d9323) {
                return _0x4be48e.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 VINIZIAZ 𝗔𝗶, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
              }
        ...
        case "getvar":
          ...
          let _0x5748f4 = "*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 VINIZIAZ-𝗠𝗗:*\n\n";
